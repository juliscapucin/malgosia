    ...
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <div className="bg-secondary/30 fixed inset-0" aria-hidden="true" />
          </Transition.Child>
          <Transition.Child
            as={Fragment}
            enter="transition-all ease-in-out duration-300"
          ...
          >
            <Dialog.Panel className="border-faded bg-primary/80 fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l p-6 backdrop-blur-xl md:w-[390px]">
              ...
              {!cart || cart.lines.length === 0 ? (
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                  ...
                  <div className="text-faded py-4 text-sm">
                    ...
                    <div className="border-faded mb-3 flex items-center justify-between border-b pb-1 pt-1">
                      <p>Shipping</p>
